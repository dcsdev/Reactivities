    ...
    return (
        <Segment.Group>
            <Segment basic attached='top' style={{ padding: '0' }}>
                {activity.isCancelled && <Label style={{ position: 'abosolute', zIndex: 1000, left: -14, top: 20 }} ribbon color='red' content='Cancelled' ></Label>}
                ...
                {activity.isHost ? (
                    <>
                        <Button color={activity.isCancelled ? 'green' : 'red'}
                            floated='left'
                            basic
                            content={activity.isCancelled ? 'Reactivate' : 'Cancel Activity'}
